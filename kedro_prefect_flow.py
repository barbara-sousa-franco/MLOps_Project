...
Training is a single pass:
  compare_models → feature_selection (RFE) → tune_model (Optuna) → model_train
"""
...
# ----------------------------------------------------------------------------
# full pipeline: data_prep -> [traffic-light gate] -> training (single pass)
# -> inference -> monitoring -> explainability -> reporting
# ----------------------------------------------------------------------------
